...
public class Methods 
{
    ...
    {
        System.out.println("Developed by: John Corrigan");
        ...
        System.out.println("Progarm validates user input for integers greater than 0.");
    ...
    public static void generatePsuedoRandomNumbers(int[] myArray)
    {
        Random r = new Random();
        int i = 0;
